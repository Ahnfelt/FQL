...
We define the rules for equality to cover all the possible cases of construcs that can be used in a equality construct. The interesting rules are the rules for set. 
\[\begin{array}{c}
