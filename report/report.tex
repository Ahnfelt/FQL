...
\begin{itemize}
\item Case $\T = \rule{\noteover{\te{}t_1:\tau_1}{\T_1} \quad 
\noteover{\te{x\mapsto\tau_1} t_2 : \tau_2}{\T_2}}
  {[] \vdash \sletin{x = t_1}{t_2} : \tau_2}$

By IH on $\T_1$ either $t_2$ is cannonical or $t_1 \step t_1'$. If
$t_1 \step t_1'$ then $\T$ can step using S-Let1. If $t_1=c$
